...
public class Main {
	...
	private static void processBlendableFrames(String directory, int minFrameIndex, int maxFrameIndex) throws IOException {
		HashMap<Integer, BlendFrameCluster> clusters = BlendFrameCluster.getBlendClustersFromDirectory(directory, minFrameIndex, maxFrameIndex);
		// blend the clusters.
	...
	public static void main(String a[]) throws Exception {
		...
		processBlendableFrames(config.directory, config.minFrameIndex, config.maxFrameIndex);
	}
}