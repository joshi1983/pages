...
import { Orientation2D } from './Orientation2D.js';
...
export class Orientation extends AbstractOrientation {
	...
	rollRight(angleRadians) {
		this.rollRadians = clampRadianAngle(angleRadians + this.rollRadians);
	...
	pitchUp(angleRadians) {
		this.pitchRadians = clampRadianAngle(this.pitchRadians + angleRadians);
		this.m = undefined;
	}
