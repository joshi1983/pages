...
const lineProc = await fetchText('content/drawing/download/post-script/line.ps.dat') + '\n';
const circleProc = await fetchText('content/drawing/download/post-script/circle.ps.dat') + '\n';
const ellipseProc = await fetchText('content/drawing/download/post-script/ellipse.ps.dat') + '\n';
const rotatedEllipseProc = await fetchText('content/drawing/download/post-script/rotatedellipse.ps.dat') + '\n';
