import { bindKeyboardShortcutListener } from './code-editor/shortcuts/bindKeyboardShortcutListener.js';
...
import { executeShortcut } from './code-editor/shortcuts/executeShortcut.js';
		...
		if (this._loadDependenciesPromise === undefined) {
			...
			this._loadDependenciesPromise = new Promise(function(resolve, reject) {
				...
				*/
				...
				import('./code-editor/autoRunMenuItem.js');
				...
				import('./code-editor/pseudoRandomizationMenuItem.js');
				...
				import('./code-editor/quality-report/showQualityReport.js');
