import { countRegexMatches } from '../helpers/countRegexMatches.js';
...
// some indicators of other types of BASIC
/(^|\s)DECLARE[ \t]+(FUNCTION|SUB)[ \t]+[a-z]/i,
/(^|[\s\(\[])DEF(|DBL|INT|LNG|SNG)[ \t]+[a-z]/i,
/(^|[\s\(\[])DIM[ \t]+[a-z]/i,
/(^|[\s\(\[])SUB[ \t]+[a-z]/i,
];
