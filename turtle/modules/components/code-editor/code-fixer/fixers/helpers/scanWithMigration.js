...
import { processRemoveInMigrationKeywordsForScanTokens } from
'./processRemoveInMigrationKeywordsForScanTokens.js';
import { processRemoveInMigrationScanTokens } from
'./processRemoveInMigrationScanTokens.js';
import { processScanTokenOperators } from
'./processScanTokenOperators.js';
...
export function scanWithMigration(code, migrationInfo) {
	...
	processRemoveInMigrationKeywordsForScanTokens(webLogoTokens, migrationInfo);
	processScanTokenOperators(webLogoTokens, migrationInfo);
