...
export class LineNumber {
	constructor(index) {
		...
		this.isExecutionBranchingPoint = false;
	...
	setExecutionBranchingPoint(isExecutionBranchingPoint) {
		if (isExecutionBranchingPoint !== this.isExecutionBranchingPoint) {
			this.isExecutionBranchingPoint = isExecutionBranchingPoint;
			if (isExecutionBranchingPoint)
				this.isExecutionPoint = false; // can't be both an execution branching point and an execution point
			this.refreshDivClasses();
		}
	}
