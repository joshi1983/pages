import { bindKeyboardShortcutListener } from './shortcuts/bindKeyboardShortcutListener.js';
...
import { executeShortcut } from './shortcuts/executeShortcut.js';
import { fetchText } from '../../fetchText.js';
import { GraphicsScreen } from '../GraphicsScreen.js';
import { LogoTextarea } from './LogoTextarea.js';
	...
	loadDependencies() {
		if (this._loadDependenciesPromise === undefined) {
			...
			this._loadDependenciesPromise = new Promise(function(resolve, reject) {
				...
				*/
				import('./autoFixCodeMenuItem.js');
				import('./autoRunMenuItem.js');
				import('./EditCopy.js');
				import('./EditPaste.js');
				import('./formatCodeMenuItem.js');
				import('./harmonizeCaseMenuItem.js');
				import('./logo-textarea/parseMessageUpdater.js');
				import('./pseudoRandomizationMenuItem.js');
				import('./runTest.js');
				import('./resetAll.js');
				import('./resetAndTest.js');
				import('./resetGlobalVariables.js');
				import('./setupAnimationMenuItem.js');
				import('./showAutofixPrompt.js');
				import('./quality-report/showQualityReport.js');
				import('../CommandBoxMessages.js').then(function(result) {
					const CommandBoxMessages = result.CommandBoxMessages;
					import('./logo-textarea/ExecutionPointUpdater.js').then(function(result) {
						...
						bindKeyboardShortcutListener(outer.textElement.txtarea, executeShortcut);
