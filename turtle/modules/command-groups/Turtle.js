...
import { distanceToLines } from './helpers/distanceToLines.js';
...
import { roundParallelogram } from './helpers/drawing/roundParallelogram.js';
...
export class Turtle extends EventDispatcher {
	...
	distanceToLines(lines) {
		return distanceToLines(this, lines);
	}
	...
	roundParallelogram(width, slantedHeight, angleDegrees, cornerRadius) {
		roundParallelogram(this, width, slantedHeight, angleDegrees, cornerRadius);
	}
