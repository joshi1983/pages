...
const maximizeButton = debuggerElement.querySelector('#debugger-maximize');
...
const restoreButton = debuggerElement.querySelector('#debugger-restore');
...
function maximizeClicked() {
	debuggerElement.removeAttribute('style');
	debuggerElement.classList.add('maximized');
	maximizeButton.style.display = 'none';
	restoreButton.style.display = 'inline-block';
	Debugger.maximized = true;
}

function restore() {
	debuggerElement.classList.remove('maximized');
	restoreButton.style.display = 'none';
	maximizeButton.style.display = 'inline-block';
	Debugger.maximized = false;
}
...
maximizeButton.addEventListener('click', maximizeClicked);
parseTreeExplorerButton.addEventListener('click', showParseTreeExplorer);
restoreButton.addEventListener('click', restoreClicked);
