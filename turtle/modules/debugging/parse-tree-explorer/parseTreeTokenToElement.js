function createHeadingLine(parseTreeToken, ParseTreeTokenType) {
	...
	let coordinatesStr = parseTreeToken.colIndex + ', ' + parseTreeToken.lineIndex;
	if (parseTreeToken.indentLevel !== undefined)
		coordinatesStr += ', ' + parseTreeToken.indentLevel;

	positionSpan.innerText = coordinatesStr;
