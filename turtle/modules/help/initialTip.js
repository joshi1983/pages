...
function showTip(id) {
	// If the user opened another dialog before the tip could show,
	// give up on showing a tip.
	// We don't want to interrupt what the user is busy doing by closing their dialog.
	if (Dialog.isVisible())
		return;
