...
import { updatePredicateExplanation } from './command-details/updatePredicateExplanation.js';
...
export class CommandDetails {
	static showDetails(commandName) {
		...
		Dialog.show(html, commandInfo.primaryName.toUpperCase() + ' Command Details', undefined, undefined, {
		...
		updatePredicateExplanation(commandInfo);
		processHelpLinks();
	}
};