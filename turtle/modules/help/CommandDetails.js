...
import { updateEqualities } from './command-details/updateEqualities.js';
...
export class CommandDetails {
	static showDetails(commandName, autoAddPushState) {
		...
		if (commandInfo.isUnstable) {
			const unstableP = document.getElementById('unstable-message');
			unstableP.classList.remove('hidden');
		}
		updateEqualities(commandInfo.primaryName);
