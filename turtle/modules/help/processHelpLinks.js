...
function processColourBlendModeLinks(e) {
	const blendModeSpans = e.querySelectorAll('.help-color-blend-modes');
	blendModeSpans.forEach(function(span) {
		if (!span.hasAttribute('title')) {
			span.setAttribute('title', 'Learn more about color blend modes');
