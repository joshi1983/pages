import { assetDataToBase64URI } from './assetDataToBase64URI.js';
...
export class Asset {
	...
	// data should be base-64 encoded but without the format and base64 prefix.
	...
	getBase64URI(optionalMimeOverride) {
		...
		return assetDataToBase64URI(this.data, optionalMimeOverride);
	}
