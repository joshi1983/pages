...
import { findLongestMatch, isNumeric, signedNumberRegEx } from './Numbers.js';
const operatorsData = await fetchJson('json/operators.json');
const operatorSymbolsArray = operatorsData.map((od) => od.symbol);
const operatorSymbols = new Set(operatorSymbolsArray);
