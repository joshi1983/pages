...
function isGoodPreviousUp(token, functionsMap) {
...
function getGoodPrevious(token, functionsMap) {
...
export function processBinaryOperator(prev, next, functionsMap) {
	prev = getGoodPrevious(prev, functionsMap);
