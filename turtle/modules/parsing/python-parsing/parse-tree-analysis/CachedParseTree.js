...
import { getAllImportedPackages } from './getAllImportedPackages.js';
...
export class CachedParseTree {
	...
	getAllImportedPackages() {
		if (this.importedPackages === undefined) {
			this.importedPackages = getAllImportedPackages(this.root);
		}
