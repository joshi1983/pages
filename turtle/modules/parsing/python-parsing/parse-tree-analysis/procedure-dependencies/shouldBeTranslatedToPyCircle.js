...
export function shouldBeTranslatedToPyCircle(cachedParseTree, circleToken) {
	...
	let children = circleToken.children;
	// FIXME: this if-statement will always be true after DT Python Parser usage is removed.
	// This should be adjusted to reflect that after DT Python Parser gets removed.
