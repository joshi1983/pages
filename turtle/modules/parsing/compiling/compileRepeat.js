...
export function compileRepeat(parseTreeTokens, procedures, result, logger) {
	const repeatInstructionsToken = parseTreeTokens[0];
	const repeatToken = repeatInstructionsToken.parentNode;
	getInstructionsFromToken(repeatInstructionsToken, procedures, result, logger);
