...
function getVariablesModifiedBySpecialCommands(instructions) {
	const commandNames = ['dequeue', 'dequeue2', 'queue', 'queue2', 'setItem', 'setProperty'];
	const variableGroups = commandNames.map(name => getVariablesModifiedByCommand(instructions, name));
	const result = [];
