...
import { getAbsReturnTypes } from './getAbsReturnTypes.js';
import { getDotReturnTypes } from './getDotReturnTypes.js';
import { getItemReturnTypes } from './getItemReturnTypes.js';
import { getMaxReturnTypes } from './getMaxReturnTypes.js';
import { getMinReturnTypes } from './getMinReturnTypes.js';
import { getMixReturnTypes } from './getMixReturnTypes.js';
import { getOperatorAggregateReturnTypes } from './getOperatorAggregateReturnTypes.js';
import { getRPutReturnTypes } from './getRPutReturnTypes.js';
import { getVectorAddSubtractReturnTypes } from './getVectorAddSubtractReturnTypes.js';
import { getVectorScaleReturnTypes } from './getVectorScaleReturnTypes.js';
...
const commandGetReturnTypes = {
	...
	'difference': getOperatorAggregateReturnTypes('-'),
	'dot': getDotReturnTypes,
	...
	'lput': getRPutReturnTypes,
	'max': getMaxReturnTypes,
	'min': getMinReturnTypes,
	...
	'product': getOperatorAggregateReturnTypes('*'),
	...
	'sum': getOperatorAggregateReturnTypes('+'),
	'vectorAdd': getVectorAddSubtractReturnTypes('+'),
	'vectorScale': getVectorScaleReturnTypes,
	'vectorSubtract': getVectorAddSubtractReturnTypes('-')
};
