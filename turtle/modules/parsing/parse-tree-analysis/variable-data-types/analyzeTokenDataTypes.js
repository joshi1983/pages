...
import { processTokenDataTypesFromMultipleVariableScopes } from './processTokenDataTypesFromMultipleVariableScopes.js';
...
export function analyzeTokenDataTypes(cachedParseTree, tokenValueMap, variables) {
	...
	processTokenDataTypesFromMultipleVariableScopes(cachedParseTree, variables, result);
