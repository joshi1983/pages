...
export function analyzeLengthForVariable(cachedParseTree, tokenLengthsMap,
valueToken, procedureCallsMayChangeLength, tokenValueMap) {
	...
	while (instructionToken !== null) {
		...
		if (canBeInterpretted(instructionToken, variableName, tokenValueMap)) {
			length = interpretCommand(instructionToken, length, variableName, tokenValueMap);
		}
