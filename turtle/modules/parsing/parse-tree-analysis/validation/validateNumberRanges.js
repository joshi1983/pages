...
import { getDescendentsOfTypes } from '../../parse-tree-token/getDescendentsOfTypes.js';
...
function mightNotBeConstant(token) {
	...
	if (info.primaryName === 'pick' || info.primaryName === 'random' || info.primaryName === 'randomRatio')
		return true;
	return false;
}
