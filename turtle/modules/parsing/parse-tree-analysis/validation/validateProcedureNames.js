...
export function validateProcedureNames(cachedParseTree, parseLogger, options) {
	...
	procedures.forEach(function(proc) {
		...
		if (commandInfo !== undefined) {
			if (commandInfo.commandGroup !== 'internalProc' || options.allowProcsMatchingCommandNames !== true) {
