			...
			if (token.children.length > index && arg.minLen !== undefined) {
				...
				if (len !== undefined) {
					if (arg.maxLen < len) {
						let msg;
						if (v === undefined)
							msg = 'The maximum length is ' + arg.maxLen + ' but you are inputting a value with length ' + len;
						else if (typeof v === 'string')
							msg = 'The maximum string length is ' + arg.maxLen + ' but you are inputting a string with length ' + len;
						else
							msg = 'The maximum list length is ' + arg.maxLen + ' for command ' + info.primaryName + ' but you are inputting a list with length ' + len;
