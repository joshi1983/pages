...
import { processArrayLiteral } from './processArrayLiteral.js';
...
import { processConstDeclarationList } from './processConstDeclarationList.js';
...
const typeProcessors = new Map([
	...
	[ParseTreeTokenType.ARRAY_LITERAL, processArrayLiteral],
	...
	[ParseTreeTokenType.CONST_DECLARATION_LIST, processConstDeclarationList],
