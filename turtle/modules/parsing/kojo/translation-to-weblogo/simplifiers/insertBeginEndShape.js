...
const pathInteruptingNames = new Set([
	'circle', 'cleari', 'cleari', 'ellipse', 'hop',
	'setFillColor', 'setPenColor', 'setPenThickness',
	'write'
]);

const pathFunctionNames = new Set([
	'back', 'bezierVertex', 'curveVertex', 'curveVertexRt', 'forward', 'left', 'right',
	'quadraticVertex', 'vertex', 'vertexRt'
]);
...
export function insertBeginEndShape(root) {
	const blocks = getDescendentsOfTypes(root, [
		...
		ParseTreeTokenType.TREE_ROOT]).filter(isOfInterest);
