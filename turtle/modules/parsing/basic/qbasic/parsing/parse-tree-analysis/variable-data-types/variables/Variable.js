...
export class Variable {
	constructor(name) {
		...
		this.declarations = [];
		this.assignments = [];
		this.arrayElementAssignments = [];
	}

	addArrayElementAssignment(assignmentToken) {
		this.arrayElementAssignments.push(assignmentToken);
	}
	...
	isArrayAt(token) {
		...
		if (declaration === undefined) {
			return this.arrayElementAssignments.length !== 0;
		}
