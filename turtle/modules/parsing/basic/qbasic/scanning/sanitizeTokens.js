...
const sReplacements = new Map([
	['–', '-'] // Note that these look the same but are different.
		// They both look like - but have different underlying character codes.
		// This potential confusion is why we're replacing it.
]);
