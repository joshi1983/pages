...
// QBASIC does not support comments starting with // but Basil Basic and pBasic does.
// This converts Basil Basic's, pBasic's //-comments to REM comments.
export function convertDoubleSlashSingleLineComments(scanTokens) {
