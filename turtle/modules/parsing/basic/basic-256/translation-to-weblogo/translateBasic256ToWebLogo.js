...
import { renameExtraParameterizedGroups } from
'../../../../components/code-editor/code-fixer/fixers/helpers/renameExtraParameterizedGroups.js';
...
export function translateBasic256ToWebLogo(basic256Code) {
	...
	if (renameExtraParameterizedGroups(tree, migrationInfo)) {
		translated = parseTreeToCodeWithComments(tree, translated);
	}
