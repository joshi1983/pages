...
import { isNotObjectKey } from './undefined-identifiers/isNotObjectKey.js';
...
export function validateUndefinedIdentifiers(cachedParseTree, parseLogger) {
	const identifierTokens = getTokensByType(cachedParseTree, ParseTreeTokenType.IDENTIFIER).filter(isNotObjectKey);
