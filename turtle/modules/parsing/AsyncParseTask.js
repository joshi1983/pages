...
function asyncInit() {
	return new Promise(function(resolve, reject) {
		...
		new AsyncParseTask(code, proceduresMap, _resolve, _reject, true);
	});
}
...
export class AsyncParseTask {
	...
	constructor(code, proceduresMap, resolve, reject, isHidingErrors) {
	...
	static startProcessing() {
		...
		currentTask = parseTasks[0];
		parseTasks.shift(1); // remove task.
