...
export class Command {
	...
	static getArgCount(commandInfo) {
		...
		let defaultCount = commandInfo.args.length;
		if (typeof commandInfo.argCount === 'object' && commandInfo.argCount.default !== undefined)
			defaultCount = commandInfo.argCount.default;
		const result = {
	...
	static getParameterTypes(commandInfo, parameterIndex) {
		...
		else if (commandInfo.extraArgsInfo !== undefined)
			return commandInfo.extraArgsInfo.types;
		else
