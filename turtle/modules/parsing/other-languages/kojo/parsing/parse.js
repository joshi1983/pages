...
import { sanitizeFunctionCalls } from
'./sanitizeFunctionCalls.js';
import { scan } from '../scanning/scan.js';
import { stringToTokenType } from './stringToTokenType.js';
import { tokenToParseTreeToken } from
'../../../generic-parsing-utilities/tokenToParseTreeToken.js';
...
export function parse(code) {
	...
	let prev = root;
	let prevTokenType = ParseTreeTokenType.TREE_ROOT;
