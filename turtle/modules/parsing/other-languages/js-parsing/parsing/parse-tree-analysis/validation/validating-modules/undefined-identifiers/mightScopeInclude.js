...
import { getLastTokenForScope } from
'../../../getLastTokenForScope.js';
import { hasAncestor } from
'../../../../../../../generic-parsing-utilities/hasAncestor.js';
import { isAfterOrSame } from
'../../../../../../../generic-parsing-utilities/isAfterOrSame.js';
import { isDefiningInFunctionNotAccessibleFromIdentifier } from './isDefiningInFunctionNotAccessibleFromIdentifier.js';
...
export function mightScopeInclude(identifierToken) {
	...
	return function(definingToken) {
		if (isDefiningInFunctionNotAccessibleFromIdentifier(definingToken, identifierToken)) {
			return false;
		}
