...
export function validateFunction(token, parseLogger) {
	...
	if (badParentTypes.has(parent.type))
		parseLogger.error(`Expected FUNCTION type token to not have a type of ${ParseTreeTokenType.getNameFor(parent.type)} but found it`, token);
