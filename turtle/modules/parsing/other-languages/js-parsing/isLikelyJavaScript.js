...
const unlikelyPatterns = [
	...
	// indicators of BeanShell
	/(^|[\r\n])\s*[a-zA-Z_][a-zA-Z_\d]*[ \t]*\([ \t]*(bool|double|float|int|String)[ \t]+[a-zA-Z_][a-zA-Z_\d]*[ \t]*[,\)]/,
	...
	// indicators of Java
	/(^|[\r\n])[ \t]*import[ \t]+[a-zA-Z_][a-zA-Z_\d]*([ \t]*\.[ \t]*[a-zA-Z_][a-zA-Z_\d]*)*[ \t]*(\.[ \t]*\*)?[ \t]*;/,

	// indicators of Julia
	/(^|[\r\n])[ \t]*[a-z_]+::/,
	
	// indicators of Kotlin
	/(^|[\r\n])[ \t]*lateinit[ \t]+var[ \t]+[a-zA-Z_]/,
	/(^|[\r\n])[ \t]*fun[ \t]+[a-zA-Z_][a-zA-Z_\d]*[ \t]*\(/,
...
const likelyPatterns = [
	...
	/(^|[\r\n])[ \t]*function\s+[a-zA-Z_][a-zA-Z_\d]*\s*\(\s*([a-zA-Z_][a-zA-Z_\d]*\s*(,\s*[a-zA-Z_][a-zA-Z_\d]*)*)?\)\s*\{/,
	/(^|[\r\n])[ \t]*console[ \t]*.[ \t]*log\s*\(/,
