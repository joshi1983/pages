...
import { fixDimVariableAsTypeOrder } from './fixDimVariableAsTypeOrder.js';
import { goSubToSubroutines } from './goSubToSubroutines.js';
...
import { moveConstants } from './moveConstants.js';
...
import { removeRedundantStep } from './removeRedundantStep.js';
...
'./simplifyPiVariables.js';

const refactorers = [
	addEndIf,
	addThen,
	exitWhileToIf,
	fixDimVariableAsTypeOrder,
	goSubToSubroutines,
	gotoToDoLoopWhile,
	gotoToExitLoops,
	gotoToInfiniteLoops,
