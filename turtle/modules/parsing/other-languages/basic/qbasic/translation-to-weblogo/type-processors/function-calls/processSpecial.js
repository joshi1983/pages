...
import { getToNameForPalette, palette } from './palette.js';
import { ParseTreeTokenType } from '../../../ParseTreeTokenType.js';
import { point, getToName as pointToName } from './point.js';
import { processSpecialCommand } from
...
const specials = [_cv, _mk$, _palettecolor,
	_pi, _rgb, _rgb32,
	circle, color, end, input, left$,
	line, line_input, mid$, palette, point, preset, pset, read,
	restore, rnd, screen, space$, stop, swap, tab];
