...
// indicators of Turing
/(^|[\r\n])\s*%/, // a comment in Turing
/[\r\n]\s*end[ \t]+loop(\s|$)/i,
...
// True Basic follows the ANSI BASIC standard and frequently uses ! for comments too.
...
/(\n|^)[ \t]*(\d+[ \t]+)?end[ \t]+picture(\s|$)/i, // might also indicate True Basic
