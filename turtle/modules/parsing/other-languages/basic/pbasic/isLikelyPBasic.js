...
const unlikelyExpressions = [
	...
	/(^|[\r\n])\s*for[ \t]+[\[\(]/i,
		...
		// The square bracket like for [ would be a pattern found in a lot of Logo programs.
		// pBasic's for-loops always have an identifier immediately after the "for" keyword.

	/(^|[\r\n])\s*(def|function)[ \t]+[a-zA-Z_\d]/,
		// can match Python and JavaScript function definitions
		// pBasic would use func instead.
