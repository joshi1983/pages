...
const unlikelyRegexes = [
	// indicators of Apex ( from Salesforce)
	/(^|[\r\n])\s*(global\s+)?static\s+(Boolean|Datetime|Double|ID|Long|Null|String)\s/, 
	...
	/(^|\s)function\s+/, // part of a function implementation in JavaScript
	/[\s|{]case\s*:\s+/, // part of a switch statement in JavaScript
