...
Lists data for documentation of various blend modes.
The blend modes are used in commands like setPenBlendMode and setFillBlendMode.

The descriptions were copied and adapted from:
