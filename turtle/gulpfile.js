...
gulp.task('indexes', () => {
	...
	indexFiles('./logo-scripts/basic/basic-256', 'lgo');
	...
	indexFiles('./logo-scripts/kojo-content', 'lgo');
	...
	indexFiles('./logo-scripts/turtle-graphics-fun', 'lgo');
	indexFiles('./tests/data/ada', 'txt');
	indexFiles('./tests/data/apex-salesforce', 'txt');
	...
	indexFiles('./tests/data/basic/basic-256', 'txt');
	indexFiles('./tests/data/basic/basic-fusion', 'txt');
	indexFiles('./tests/data/basic/bazz-basic', 'txt');
	...
	indexFiles('./tests/data/basic/pbasic', 'txt');
	...
	indexFiles('./tests/data/basic/visual-basic-for-applications', 'txt');
	indexFiles('./tests/data/batch', 'txt');
	indexFiles('./tests/data/bcpl', 'txt');
	indexFiles('./tests/data/beanShell', 'txt');
	indexFiles('./tests/data/cobol', 'txt');
	indexFiles('./tests/data/css', 'txt');
	indexFiles('./tests/data/dart', 'txt');
	indexFiles('./tests/data/elm', 'txt');
	indexFiles('./tests/data/forth', 'txt');
	indexFiles('./tests/data/gleam', 'txt');
	indexFiles('./tests/data/groovy', 'txt');
	indexFiles('./tests/data/haskell', 'txt');
	indexFiles('./tests/data/holy-c', 'txt');
	indexFiles('./tests/data/hpgl', 'txt');
	indexFiles('./tests/data/java', 'txt');
	indexFiles('./tests/data/javascript-2d-canvas', 'txt');
	indexFiles('./tests/data/javascript-processing', 'txt');
	indexFiles('./tests/data/kojo', 'txt');
	indexFiles('./tests/data/kotlin', 'txt');
	...
	indexFiles('./tests/data/lisp/arc', 'txt');
	...
	indexFiles('./tests/data/logo-scripts/german-logo', 'lgo');
	...
	indexFiles('./tests/data/logo-scripts/sea-turtle', 'txt');
	...
	indexFiles('./tests/data/lua', 'txt');
	indexFiles('./tests/data/math/julia', 'txt');
	indexFiles('./tests/data/math/matlab', 'txt');
	indexFiles('./tests/data/ml', 'txt');
	indexFiles('./tests/data/ml/ocaml', 'txt');
	indexFiles('./tests/data/modula-2', 'txt');
	indexFiles('./tests/data/odin', 'txt');
	indexFiles('./tests/data/osmosian-plain-english', 'txt');
	indexFiles('./tests/data/pascal', 'txt');
	indexFiles('./tests/data/pascal/turing', 'txt');
	indexFiles('./tests/data/perl', 'txt');
	indexFiles('./tests/data/php', 'txt');
	...
	indexFiles('./tests/data/prolog', 'txt');
	indexFiles('./tests/data/ruby', 'txt');
	indexFiles('./tests/data/rust-turtle', 'txt');
	indexFiles('./tests/data/shaders/glsl', 'txt');
	indexFiles('./tests/data/shaders/hlsl', 'txt');
	indexFiles('./tests/data/shaders/wgsl', 'txt');
	indexFiles('./tests/data/sugarlabs-turtle-blocks', 'json');
	indexFiles('./tests/data/sugarlabs-turtle-blocks/html', 'html');
	indexFiles('./tests/data/swift', 'txt');
	indexFiles('./tests/data/turtle-graphics-fun', 'txt');
	indexFiles('./tests/data/turtletoy-net', 'txt');
	indexFiles('./tests/data/verse', 'txt');
	indexFiles('./tests/data/zig', 'txt');
