...
export function harmonizeCase(code, tree) {
	...
	if (parseLogger.hasLoggedErrors())
		...
		harmonizeCommandNameCase(writableCachedParseTree);
		harmonizeKeywordCase(writableCachedParseTree);
		harmonizeProcedureNameCase(writableCachedParseTree);
		harmonizeVariableNameCase(writableCachedParseTree);
