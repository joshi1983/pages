...
import { getTokensByType } from '../../../../../parsing/parse-tree-analysis/cached-parse-tree/getTokensByType.js';
	...
	return function(token) {
		...
		callTokens.forEach(function(callToken) {
			...
			if (procedure === undefined) {
				...
				wCachedParseTree.tokenTypeChanged(callToken, ParseTreeTokenType.PARAMETERIZED_GROUP);
