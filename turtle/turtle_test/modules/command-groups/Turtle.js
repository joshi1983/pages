...
import { circlePair } from './helpers/circlePair.js';
...
import { isotoxalStar } from './helpers/isotoxalStar.js';
import { isoTrapezoid } from './helpers/isoTrapezoid.js';
import { isoTriangle } from './helpers/isoTriangle.js';
...
import { parallelogram } from './helpers/parallelogram.js';
...
import { regularStar } from './helpers/regularStar.js';
import { roundIsoTriangle } from './helpers/roundIsoTriangle.js';
import { roundRect } from './helpers/roundRect.js';
import { roundRegularPolygon } from './helpers/roundRegularPolygon.js';
import { StringBuffer } from '../StringBuffer.js';
import { stripes } from './helpers/stripes.js';
...
export class Turtle extends EventDispatcher {
	...
	polyEnd() {
		const shape = this.drawState.getPolyShape();
		if (shape.isVisible()) {
			this.drawing.addForegroundShape(shape);
