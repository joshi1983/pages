...
export class LogoProgram {
	...
	usesAsyncInstructions() {
		if (this.usesAsyncInstruction === undefined) {
			this.usesAsyncInstruction = false;
			if (this.instructions.some(i => i instanceof AsyncCallCommandInstruction))
				this.usesAsyncInstruction = true;
			for (let proc of this.procedures.values()) {
				if (proc.instructions.some(i => i instanceof AsyncCallCommandInstruction)) {
					this.usesAsyncInstruction = true;
					break;
				}
			}
		}
		return this.usesAsyncInstruction;
	}
};