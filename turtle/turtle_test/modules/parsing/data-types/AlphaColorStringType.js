...
export class AlphaColorStringType extends DataType {
	...
	// Unlike mayBeCompatibleWith, isDefinitelyCompatibleWith returns false 
	// if we can't rule out incompatiblity.
	static isDefinitelyCompatibleWith(token) {
		if (ColorStringType.isDefinitelyCompatibleWith(token))
			return true;
