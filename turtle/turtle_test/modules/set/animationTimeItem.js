...
import { LiveRedrawer2 } from './animation-time/LiveRedrawer2.js';
...
function itemClicked() {
	...
	LiveRedrawer2.setAnimationTimeWithoutRedraw(Settings.animationTime);
	LiveRedrawer2.refreshProgram().then(function() {
		const isUsingAnimationTime = LiveRedrawer2.isUsingAnimationTime();
		...
		function refreshCalculatedValues() {
			...
			if (liveRedrawCheckbox.checked) {
				LiveRedrawer2.redrawNeeded(inputtedSeconds);
			}
