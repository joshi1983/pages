...
export class ColorMenuItem {
	constructor(colourDialogTitle, _colour, menuItemId, isAllowingTransparent) {
	...
	selectColour() {
		...
		ColorSelectorDialog.showDialog(this.dialogTitle, colour, this.isAllowingTransparent).
