...
import { testCommandJSONOrderByPrimaryName } from './testCommandJSONOrderByPrimaryName.js';
...
function runTests() {
	...
	testCommandJSONOrderByPrimaryName(namedLog("testCommandJSONOrderByPrimaryName"));
