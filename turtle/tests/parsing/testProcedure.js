...
import { getAllDescendentsAsArray } from '../../modules/parsing/parse-tree-token/getAllDescendentsAsArray.js';
...
export function testProcedure(logger) {
	...
	const firstPrintToken = getAllDescendentsAsArray(instructionsToken).filter(t => t.val === 'print')[0];
