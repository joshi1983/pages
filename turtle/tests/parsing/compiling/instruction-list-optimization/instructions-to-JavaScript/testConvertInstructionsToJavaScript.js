...
export function testConvertInstructionsToJavaScript(logger) {
	testIfElseExprConversion(prefixWrapper('testIfElseExprConversion', logger));
	testMandelbrotConversion1(prefixWrapper('testMandelbrotConversion1', logger));
	testMakeConversion(prefixWrapper('testMakeConversion', logger));
};