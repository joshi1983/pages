...
function processCase(caseInfo, logger) {
	...
	if (instructions.length !== caseInfo.afterLength)
		logger(`Expected instructions.length to be ${caseInfo.afterLength} but got ${instructions.length}`);
	else {
