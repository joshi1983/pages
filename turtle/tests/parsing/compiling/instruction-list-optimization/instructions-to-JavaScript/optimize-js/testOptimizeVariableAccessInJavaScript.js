...
export function testOptimizeVariableAccessInJavaScript(logger) {
	...
	{
		'in': 'context.localmake("reverse?",true)',
		'changed': false
	},
	{
	...
	{
		'in': 'context.localmake("reverse?",true);\ncontext.localmake("reverse?",false);',
		'out': 'let reversep = context.getCurrentExecutingProcedure().localVariables.get("reverse?");\nreversep=true ;\n reversep=false ;\ncontext.localmake("reverse?", reversep);'
	},
	{
