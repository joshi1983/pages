...
'out': `const localVariables = context.getCurrentExecutingProcedure().localVariables;
let reversep = localVariables.get("reverse?");
let startarcs = localVariables.get("startarcs");
let startoffset = localVariables.get("startoffset");
;
startarcs=[[109.3,0.013]] ;

if (reversep ) {
startarcs=[] ;
}

localVariables. set("arcsinfo",context.list.combine( startarcs ,[[0.971]]));
startoffset=0.14 ;
