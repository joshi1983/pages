...
export function testOptimizeWithConstantColours(logger) {
	...
	'changed': false},
	{'in': 'context.turtle.setPenColor(this.convertToAlphaColourOrTransparent(0))',
	'out': `context.turtle.setPenColor(this. ALPHACOLOR_FF000000 )`},
	{'in': `context.turtle.setPenColor(this.convertToAlphaColourOrTransparent(0));
context.turtle.setScreenColor(this.convertToColourOrTransparent(0))`,
	'out': `context.turtle.setPenColor(this. ALPHACOLOR_FF000000 );
context.turtle.setScreenColor(this.convertToColourOrTransparent(0))`},
