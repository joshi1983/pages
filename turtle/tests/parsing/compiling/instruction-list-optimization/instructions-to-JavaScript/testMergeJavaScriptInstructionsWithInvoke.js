...
function testInstructionsDTO(logger) {
...
function testMergeJavaScriptInstructions2(logger) {
...
export function testMergeJavaScriptInstructionsWithInvoke(logger) {
	testInstructionsDTO(prefixWrapper('testInstructionsDTO', logger));
	testMergeJavaScriptInstructions(prefixWrapper('testMergeJavaScriptInstructions', logger));
	testMergeJavaScriptInstructions2(prefixWrapper('testMergeJavaScriptInstructions2', logger));
