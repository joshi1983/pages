...
export function testRemoveInstructions(logger) {
	testJumpReindexing(prefixWrapper('testJumpReindexing', logger));
	testWithEmptyArray(prefixWrapper('testWithEmptyArray', logger));
	testWithOneInstruction(prefixWrapper('testWithOneInstruction', logger));
};