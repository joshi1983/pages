...
'../../../../../../../../modules/parsing/other-languages/basic/qbasic/parsing/parse-tree-analysis/variable-data-types/declarationToTypeName.js';
...
export function testDeclarationToTypeName(logger) {
	const cases = [
		...
		{'code': 'dim x', 'out': 'integer'},
		{'code': 'dim x,y', 'out': 'integer'},
		{'code': 'dim x,y,z', 'out': 'integer'},
