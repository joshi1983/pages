...
'../../../../../../modules/parsing/other-languages/basic/qbasic/scanning/isIdentifier.js';
...
export function testIsIdentifier(logger) {
	const cases = [
		...
		{'in': 'x(', 'out': false},
		{'in': 'x[', 'out': false},
		{'in': '?', 'out': true}, // ? is an alternative name for 'print' so it must be a valid identifier in QBasic.
		{'in': 'n', 'out': true},
		{'in': 'nu', 'out': true},
		{'in': 'x', 'out': true},
		{'in': 'X', 'out': true},
