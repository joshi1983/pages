import { processSanitizeTokensTestCases } from './processSanitizeTokensTestCases.js';
import { QBasicInternalFunctions } from
'../../../../../../modules/parsing/other-languages/basic/qbasic/QBasicInternalFunctions.js';
import { sanitizeTokens } from
'../../../../../../modules/parsing/other-languages/basic/qbasic/scanning/sanitizeTokens.js';
...
DEFNYB()=X`,
		...
		'code': 'Dim As Integer lines',
		'tokens': ['Dim', 'lines', 'As', 'Integer']
	},{
		'code': 'Dim As Integer lines\nDim as single x, y, z',
		'tokens': ['Dim', 'lines', 'As', 'Integer',
			'Dim', 'x', 'as', 'single', ',', 'y', 'as', 'single', ',', 'z', 'as', 'single']
	},{
		'code': 'Dim As double lines',
		'tokens': ['Dim', 'lines', 'As', 'double']
	},{
		'code': 'Dim As single lines',
		'tokens': ['Dim', 'lines', 'As', 'single']
	},{
		'code': 'Dim As string lines',
		'tokens': ['Dim', 'lines', 'As', 'string']
	},{
		'code': 'Dim As _unsigned double lines',
		'tokens': ['Dim', 'lines', 'As', '_unsigned', 'double']
	}];
	...
	processSanitizeTokensTestCases(cases, sanitizeTokens, logger);
};