...
'../../../../../modules/parsing/other-languages/basic/helpers/genericProcessToFromMultipleSourceTokens.js';
import { prefixWrapper } from
'../../../../helpers/prefixWrapper.js';
import { scan } from
'../../../../../modules/parsing/other-languages/basic/qbasic/scanning/scan.js';
...
export function testGenericProcessToFromMultipleSourceTokens(logger) {
	...
	cases.forEach(function(caseInfo, index) {
		...
		if (tokens.length !== caseInfo.outTokens.length)
			...
			`The actual token s values are ${tokens.map(t => t.s).join(',')}`);
		else {
