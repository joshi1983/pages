...
export function testIsLikelySinclairBasic(logger) {
	const cases = [];
	ArrayUtils.combine(amosBasicExamples, applesoftExamples, bazzBasicExamples,
	bbcBasicExamples, commodoreBasicExamples, microAExamples, qbasicExamples,
	smallVisualBasicExamples, tektronix405XExamples, trueBasicExamples).
