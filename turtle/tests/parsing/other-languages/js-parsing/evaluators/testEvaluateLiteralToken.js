...
'../../../../../modules/parsing/other-languages/js-parsing/evaluators/evaluateLiteralToken.js';
import { parse } from
...
export function testEvaluateLiteralToken(logger) {
	const cases = [
		...
		{'code': 'Math.SQRT1_2', 'out': Math.SQRT1_2},
		{'code': 'Math.SQRT2', 'out': Math.SQRT2},
		{'code': 'Math.PI', 'out': Math.PI},
		{'code': 'Math.E', 'out': Math.E},
