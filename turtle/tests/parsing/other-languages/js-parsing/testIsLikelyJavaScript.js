...
const nonExamples = ArrayUtils.combine(elmExamples, beanShellExamples, fmsLogoExamples,
haskellExamples, holyCExamples, juliaExamples, phpExamples,
pythonTurtleExampleFilesContent, qbasicExamples, wgslExamples);
const examples = ArrayUtils.combine(javascript2DCanvasExamples, javascriptProcessingExamples,
turtleGraphicsFunExamples, turtleToyNetExamples);
