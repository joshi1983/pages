...
'../../../../../../../../modules/parsing/other-languages/js-parsing/parsing/parse-tree-analysis/validation/validating-modules/validateUnusedIdentifiers.js';
...
for (var name in this)
	...
	{'code': 'let x = 4; console.log(`${x}`);', 'error': false},
	{'code': 'let x = 4; console.log(`${ x }`);', 'error': false},
	{'code': 'function f() {f();}`);', 'error': true}, 
	// f is not used.  Calling itself is not enough usage to avoid the error.
	{'code': 'function f() {} F();`);', 'error': true},
	// F is not the same as f in JavaScript.  It is case-sensitive.

	{'code': 'function f() {b();}`);', 'error': true},
	// f is declared but never called or read.

	{'code': 'function f() {b();} f();`);', 'error': false},
	// f is declared and called.  b is undeclared but a different validator will check for that.
	];
