...
const nonExamples = ArrayUtils.combine(basic256Examples, mlExamples,
phpExamples, processingExamples, rubyExamples);
...
print "hi`, 'out': false},
		...
		{'in': `# https://www.youtube.com/shorts/O1r2W3fNKtE
from turtle import*
import colorsys as cs`, 'out': false}
	];
