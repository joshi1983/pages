import { ParseTreeTokenType } from '../../../../modules/parsing/other-languages/processing/ParseTreeTokenType.js';
import { processParseTestCases } from './processParseTestCases.js';

export function testParseWhileLoops(logger) {
	const cases = [
		{'code': 'while true {', // weird format of Processing code but we want to parse it a special way anyway.
		'numTopChildren': 1, 'treeInfo': {
			'children': [
				{'type': ParseTreeTokenType.WHILE, 'val': 'while', 'children': [
					{'type': ParseTreeTokenType.BOOLEAN_LITERAL, 'val': 'true', 'children': []},
