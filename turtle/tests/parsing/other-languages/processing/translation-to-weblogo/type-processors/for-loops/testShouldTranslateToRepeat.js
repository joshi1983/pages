...
'../../../../../../../modules/parsing/other-languages/processing/translation-to-weblogo/type-processors/for-loops/shouldTranslateToRepeat.js';
...
export function testShouldTranslateToRepeat(logger) {
	const cases = [
		...
		{'in': 'for (int x=10;x<100;x++) { x = 3 }', 'out': false},
		{'in': 'for (int x=1;x<100;x++) { x = 3 }', 'out': false},
		{'in': 'for (int x=0,y=10;x<100;x++) {}', 'out': false},
		{'in': 'for (int x=0;x<100;x++,y=10) {}', 'out': false},
		{'in': 'for (int x=1;x<100 && x%2==0;x++) { point(x, x); }', 'out': false},
	...
	processForTokenToSimpleValueTest(cases, shouldTranslateToRepeat, logger);
};