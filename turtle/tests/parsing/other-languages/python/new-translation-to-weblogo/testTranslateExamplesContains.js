	...
	const cases = [
		...
		{"filename": "avengers-logo.py",
			"checks": [
				...
				'to draw_A', '23', '123', '60', '117', 'to draw_triangle', 'to draw_arrow', 'black'
			]
		},
		{
		...
		{"filename": "impostor-simple.py",
			"checks": [
				'#9acedc', 'to body', '90', '50', '180'
			]
		},
		{"filename": "mountain.py",
			"checks": [
				'setScreenColor', 'skyblue', 'jumpTo [ -400 -100 ]',
				'polyStart', 'repeat 2', '800', '90', '400',
				'polyEnd', 'repeat 3 [', '300', '120', 'jumpTo [ 100 -100 ]',
				'to tree'
			]
		},
		...
		{"filename": "pattern-coding-with-norman.py",
			"checks": [
				'setPenSize 2', 'setScreenColor ', 'black', '80', '250',
				'for [ "i 0 329 ] [', 'make "h :h + 0.004', ':i'
			]
		},
		...
		"checks": [
			"to draw_bicycle", "jumpTo [ -100 0 ]", "200",
			"90", "50"
		]},
