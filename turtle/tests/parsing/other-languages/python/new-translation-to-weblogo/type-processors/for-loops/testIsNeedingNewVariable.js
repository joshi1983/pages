...
'../../../../../../../modules/parsing/other-languages/python/new-translation-to-weblogo/type-processors/for-loops/isNeedingNewVariable.js';
import { parse } from
'../../../../../../../modules/parsing/other-languages/python/parsing/parse.js';
import { ParseTreeTokenType } from '../../../../../../../modules/parsing/other-languages/python/ParseTreeTokenType.js';
...
export function testIsNeedingNewVariable(logger) {
	...
	cases.forEach(function(caseInfo, index) {
		...
		const forToken = getForToken(parseResult.root);
		if (forToken === undefined)
