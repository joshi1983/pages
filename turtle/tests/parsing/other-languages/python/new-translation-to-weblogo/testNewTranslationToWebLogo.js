...
import { testConvertClosedPolyStartPolyEndToPolygon } from
'./testConvertClosedPolyStartPolyEndToPolygon.js';
...
import { testExecuteRepeat } from './testExecuteRepeat.js';
...
import { testGetIdentifierTranslationMap } from './testGetIdentifierTranslationMap.js';
...
import { testTranslateFillShape } from './testTranslateFillShape.js';
import { testTranslateImportStatements } from './testTranslateImportStatements.js';
...
export function testNewTranslationToWebLogo(logger) {
	wrapAndCall([
		...
		testConvertClosedPolyStartPolyEndToPolygon,
		...
		testGetIdentifierTranslationMap,
		...
		testTranslateFillShape,
		testTranslateImportStatements,
