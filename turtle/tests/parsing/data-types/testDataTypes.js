...
function testGetTypesCompatibleWithValue(logger) {
	const cases = [
		...
		{'in': [1.2], 'result': 'list<num(finite)>(minlen=1)'},
		{'in': [1, 1.2], 'result': 'list<num(finite)>(minlen=2)'},
		{'in': [1, "hi"], 'result': 'list<int|string>(minlen=2)'},
		{'in': [1.2, "hi"], 'result': 'list<num(finite)|string>(minlen=2)'},
