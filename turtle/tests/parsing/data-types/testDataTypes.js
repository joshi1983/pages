...
function testGetTypesCompatibleWithValue(logger) {
	const cases = [
		...
		{'in': 3.4, 'result': 'num(finite,min=3.4)'},
		...
		{'in': [1.2], 'result': 'list<num(finite,min=1.2)>(minlen=1)'},
		{'in': [1, 1.2], 'result': 'list<num(finite,min=1)>(minlen=2)'},
		{'in': [1, "hi"], 'result': 'list<int|string>(minlen=2)'},
		{'in': [1.2, "hi"], 'result': 'list<num(finite,min=1.2)|string>(minlen=2)'},
