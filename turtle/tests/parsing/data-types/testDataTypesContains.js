...
export function testDataTypesContains(logger) {
	const cases = [
		...
		{'in': ['int', 'int(min=0)'], 'out': true},
		{'in': ['int(min=-10)', 'int(min=0)'], 'out': true},
		{'in': ['int(min=10)', 'int(min=0)'], 'out': false},
		{'in': ['num', 'int'], 'out': true},
		{'in': ['num(finite)', 'num'], 'out': false},
		{'in': ['num', 'num(finite)'], 'out': true},
		{'in': ['num', 'num(min=0)'], 'out': true},
		{'in': ['num(min=1)', 'num(min=0)'], 'out': false},
		{'in': ['num(min=-1)', 'num(min=0)'], 'out': true},
		{'in': ['num(min=-1)', 'int'], 'out': false},
