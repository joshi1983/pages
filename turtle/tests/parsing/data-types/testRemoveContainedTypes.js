...
export function testRemoveContainedTypes(logger) {
	...
	{'in': 'list', 'out': 'list'},
	{'in': 'num|num', 'out': 'num'},
	{'in': 'cproc|cproc:1', 'out': 'cproc'},
	{'in': 'cproc:1|cproc:2', 'out': 'cproc:1|cproc:2'},
	{'in': 'cproc|cproc(returntypes=num)', 'out': 'cproc'},
	{'in': 'cproc(returntypes=num)|cproc:1', 'out': 'cproc(returntypes=num)|cproc:1'},
	{'in': 'cproc(returntypes=num)|cproc(returntypes=string)', 'out': 'cproc(returntypes=num)|cproc(returntypes=string)'},
