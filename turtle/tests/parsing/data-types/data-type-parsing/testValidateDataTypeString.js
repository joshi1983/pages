...
export function testValidateDataTypeString(logger) {
	...
	{'in': '', 'valid': true},
	{'in': '*', 'valid': true},
	{'in': 'int(0)', 'valid': false},
	{'in': 'int(min=0)', 'valid': true},
	{'in': 'int(min=10)', 'valid': true},
	{'in': 'list', 'valid': true},
	{'in': 'num', 'valid': true},
	{'in': 'num(finite)', 'valid': true},
	{'in': 'num(min=0)', 'valid': true},
	{'in': 'num(max=0)', 'valid': true},
	{'in': 'num(max=0,min=-2)', 'valid': true},
	{'in': 'cproc', 'valid': true},
	{'in': 'cproc:1', 'valid': true},
	{'in': 'cproc:3', 'valid': true},
	{'in': 'cproc:1:', 'valid': false},
	{'in': 'cproc:1:4', 'valid': false},
	{'in': 'cproc(returntypes=int)', 'valid': true},
	{'in': 'cproc(returntypes=int|string)', 'valid': true},
