...
export function testParseDataTypeString(logger) {
	...
	{'in': 'list<num>|num', 'tokenCount': 4, 'rootChildCount': 2, 'height': 3},
	{'in': 'list<list<num>>|num', 'tokenCount': 5, 'rootChildCount': 2, 'height': 4},
	{'in': 'list', 'tokenCount': 2, 'rootChildCount': 1, 'height': 2},
	{'in': 'list<>', 'tokenCount': 3, 'rootChildCount': 1, 'height': 3},
	];
	cases.forEach(function(caseInfo, index) {
		...
		if (str !== caseInfo.in)
			plogger(`Expected toString to return ${caseInfo.in} but got ${str}`);
	});
};