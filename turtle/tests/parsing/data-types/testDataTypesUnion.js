...
export function testDataTypesUnion(logger) {
	const cases = [
		...
		{'in': ['int', 'num'], 'out': 'num'},
		{'in': ['int', 'int(min=0)'], 'out': 'int'},
		{'in': ['int(min=10)', 'int(min=0)'], 'out': 'int(min=0)'},
		{'in': ['int', 'string'], 'out': 'int|string'},
		{'in': ['num(min=0)', 'int(min=0)'], 'out': 'num(min=0)'},
		{'in': ['num(min=0)', 'int(min=10)'], 'out': 'num(min=0)'},
		{'in': ['int|num(finite)', ''], 'out': 'num(finite)'},
		{'in': ['int', 'num(finite)'], 'out': 'num(finite)'},
		{'in': ['int', 'int(min=0)'], 'out': 'int'},
		{'in': ['num(finite)|num', ''], 'out': 'num'},
		{'in': ['num(finite)', 'num'], 'out': 'num'},
		{'in': ['num(finite,min=1)|num', ''], 'out': 'num'},
		{'in': ['num(min=1)|num', ''], 'out': 'num'},
		{'in': ['num(min=1)|num(min=0)', ''], 'out': 'num(min=0)'},
		...
		{'in': ['list<num(finite)>(minlen=3)', 'list<num(unfinite)>(minlen=3)'], 'out': 'list<num>(minlen=3)'},
