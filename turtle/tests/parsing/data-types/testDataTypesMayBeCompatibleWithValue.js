...
export function testDataTypesMayBeCompatibleWithValue(logger) {
	...
	{'types': 'num', 'val': Infinity, 'out': true},
	{'types': 'num', 'val': -Infinity, 'out': true},
	{'types': 'num', 'val': undefined, 'out': false},
	{'types': 'num', 'val': NaN, 'out': false},
	{'types': 'num(unfinite)', 'val': 4, 'out': false},
	{'types': 'num(unfinite)', 'val': 4.4, 'out': false},
	{'types': 'num(unfinite)', 'val': Infinity, 'out': true},
	{'types': 'num(unfinite)', 'val': -Infinity, 'out': true},
	{'types': 'num(finite)', 'val': 4, 'out': true},
	{'types': 'num(finite)', 'val': 4.4, 'out': true},
	{'types': 'num(finite)', 'val': Infinity, 'out': false},
	{'types': 'num(finite)', 'val': -Infinity, 'out': false},
	{'types': 'num(finite)', 'val': NaN, 'out': false},
	{'types': 'num(finite)', 'val': undefined, 'out': false},
