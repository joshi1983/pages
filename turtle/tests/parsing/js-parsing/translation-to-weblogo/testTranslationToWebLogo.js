import { testExecuteArrayUsage } from './testExecuteArrayUsage.js';
import { testExecuteMath } from './testExecuteMath.js';
import { testSimplifying } from './simplifying/testSimplifying.js';
import { testTranslateArrayUsage } from './testTranslateArrayUsage.js';
...
export function testTranslationToWebLogo(logger) {
	wrapAndCall([
		testExecuteArrayUsage,
		testExecuteMath,
		testSimplifying,
		testTranslateArrayUsage,
