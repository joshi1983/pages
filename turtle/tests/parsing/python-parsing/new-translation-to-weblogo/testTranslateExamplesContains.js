...
export function testTranslateExamplesContains(logger) {
	const cases = [
		...
		"checks": [
			'black', 'or ', 'orange', 'ifelse :n [', ':m = 0', ':m = 60', 'left 1', 'forward 3'
		]},
		...
		},
		{
			...
			"checks": [
				'to draw_all_flags', 'to flag_Greece :x :y :width :height',
				'to cross_filled :x :y :width :height',
				'to horizontal_strips :x :y :width :height',
				'to vertical_strips :x :y :width :height',
				'to cross :center_x :center_y :width',
				'to rectangle_filled :x :y :width :height :rotation',
		...
		"checks": [
			...
			'orange', 'brown', 'black', 'red', 'Window 2 Cross - Horizontal Line',
		...
		"checks": [
			'purple', 'orange', 'setPenSize 10', 'ircle 90'
		]},
