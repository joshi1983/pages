...
rec(0, 6)`,
		...
		{'in': 'from math import *\nprint(degrees(0))', 'messages': ['0']},
		{'in': 'from math import degrees\nprint(degrees(0))', 'messages': ['0']},
		{'in': 'import math\nprint(math.degrees(0))', 'messages': ['0']},
		{'in': 'import math\nprint(math.degrees(math.pi))', 'messages': ['180']},
		{'in': 'import math\nprint(math.degrees(math.pi/2))', 'messages': ['90']},
		{'in': 'import math\nprint(math.radians(180))', 'messages': ['3.141593']},
		{'in': 'import math\nprint(math.radians(0))', 'messages': ['0']},
		{'in': 'from math import *\nprint(radians(0))', 'messages': ['0']},
