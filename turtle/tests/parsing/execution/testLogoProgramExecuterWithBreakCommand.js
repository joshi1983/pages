...
while true [
	...
	print ['before if, z=' :z]
	if :z < 0.0001 [
		break ; z < 0 so this should exit the while-loop.
	]
	print ["z= :z]
	for ["x -1 1] [
		for ["y -1 1] [
...
forever [
	...
	print ['before if, z=' :z]
	if :z < 0.0001 [
		break ; z < 0 so this should exit the forever-loop.
	]
	print ["z= :z]
	for ["x -1 1] [
		for ["y -1 1] [
...
do.while [
	...
	print ['before if, z=' :z]
	if :z < 0.0001 [
		break ; z < 0 so this should exit the do.while-loop.
	]
	print ["z= :z]
	for ["x -1 1] [
		for ["y -1 1] [
...
until false [
	...
	print ['before if, z=' :z]
	if :z < 0.0001 [
		break ; z < 0 so this should exit the until-loop.
	]
	print ["z= :z]
	for ["x -1 1] [
		for ["y -1 1] [
