...
export function testLogoProgramExecuterOperators(logger) {
	const cases = [
		...
		{'code': 'print 1/0', 'messages': ['Infinity'], 'ignoreWarnings': true},
		{'code': 'print 1/0 + 1', 'messages': ['Infinity'], 'ignoreWarnings': true},
		{'code': 'print -1/0', 'messages': ['-Infinity'], 'ignoreWarnings': true},
		{'code': 'print 10 - 1/0', 'messages': ['-Infinity'], 'ignoreWarnings': true},
	];
