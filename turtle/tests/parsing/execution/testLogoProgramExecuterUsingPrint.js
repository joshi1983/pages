...
export function testLogoProgramExecuterUsingPrint(logger) {
	const cases = [
		...
		{'code': 'print \'it\\\'s\'', 'messages': ['it\'s']},
		{'code': 'print "it\\\'s', 'messages': ['it\'s']},
		{'code': 'print \'he said, \\"hi\\"\'', 'messages': ['he said, "hi"']},
		{'code': 'make "x 1\nprint -:x', 'messages': ['-1']},
		{'code': 'to p\noutput 1\nend\nprint -p', 'messages': ['-1']},
		...
		{'code': `print ['(' ')']`, 'messages': ['[( )]']},
		{'code': `print ['[' ']']`, 'messages': ['[[ ]]']},
		{'code': 'print plist? createPList', 'messages': ['true']},
		{'code': 'print hasProperty createPList "x', 'messages': ['false']},
		{'code': 'print hasProperty createPList2 [["x 4]] "x', 'messages': ['true']},
		{'code': 'make "x createPList2 [["x 4]]\nprint plist "x', 'messages': ['[x 4]']},
		...
		{
			'code': 'make "plist1 createPList\nprint :plist1\nsetProperty "plist1 "x 5\nprint getProperty2 :plist1 "x',
			'messages': ['[]', '5']
		},
		{
			'code': 'make "plist1 createPList2 [["x 5]]\nprint getProperty2 :plist1 "x',
			'messages': ['5']
		},
		{
			'code': 'make "plist1 createPList2 [["x 5]]\nsetProperty2 :plist1 "x 2\nprint getProperty "plist1 "x',
			'messages': ['2']
		},
		{
			'code': 'make "plist1 createPList2 [["x 5]]\nsetProperty2 :plist1 "x 2\nprint getProperty2 :plist1 "x',
