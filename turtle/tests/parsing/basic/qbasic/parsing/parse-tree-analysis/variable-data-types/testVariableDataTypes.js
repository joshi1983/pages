import { testDeclarationToTypeName } from
'./testDeclarationToTypeName.js';
import { testGetForLoopVariableName } from
'./testGetForLoopVariableName.js';
...
export function testVariableDataTypes(logger) {
	wrapAndCall([
		testDeclarationToTypeName,
		testGetForLoopVariableName,
