...
import { wrapSingleTreeInfoObject } from
'../../../helpers/parsing/processParseTestCases.js';

export function testParseForLoop(logger) {
	const cases = [{
		// QBASIC and QB64 doesn't support for-each loops but supporting them 
		// will help the QBASIC translator in WebLogo be reused for other dialects of BASIC that do support for-each loops.
		'code': `FOR EACH num IN x
NEXT num`,
		'numTopChildren': 1,
		'treeInfo': {
			'children': [
				{'val': null, 'type': ParseTreeTokenType.FOR_EACH, 'children': [
					{'val': 'FOR', 'type': ParseTreeTokenType.FOR, 'children': []},
					{'val': 'EACH', 'type': ParseTreeTokenType.EACH, 'children': []},
