...
const paths = [
	'json/logo-migrations/basic/amos-basic/migrationToQBasic.json',
	'json/logo-migrations/basic/applesoft-basic/migrationToQBASIC.json',
	'json/logo-migrations/basic/atari-turbo-basic-xl/migrateToQBasic.json',
	'json/logo-migrations/basic/basic-256/migrateToQBasic.json',
	'json/logo-migrations/basic/basic-fusion/Basic_Fusion_to_QBasic.json',
	'json/logo-migrations/basic/basil/Basil_Basic_to_QBasic.json',
	'json/logo-migrations/basic/bazz-basic/migrationToQBasic.json',
	...
	'json/logo-migrations/basic/micro-a/migrationToQBasic.json',
	'json/logo-migrations/basic/pbasic/migrationToQBasic.json',
	...
	'json/logo-migrations/basic/texas-instruments-99-4a/migrationToQBasic.json',
