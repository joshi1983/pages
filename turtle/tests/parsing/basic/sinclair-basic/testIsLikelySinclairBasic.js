...
export function testIsLikelySinclairBasic(logger) {
	const cases = [];
	bazzBasicExamples.concat(qbasicExamples).concat(amosBasicExamples).concat(applesoftExamples).concat(bbcBasicExamples).
	concat(commodoreBasicExamples).concat(microAExamples).concat(smallVisualBasicExamples).
	concat(tektronix405XExamples).concat(trueBasicExamples).
