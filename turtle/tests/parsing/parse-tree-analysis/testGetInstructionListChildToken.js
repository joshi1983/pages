...
export function testGetInstructionListChildToken(logger) {
	...
	testWithForLoop(prefixWrapper('testWithForLoop', logger));
	testWithIfElseExpression(prefixWrapper('testWithIfElseExpression',logger));
	testWithIfElseStatement(prefixWrapper('testWithIfElseStatement', logger));
};