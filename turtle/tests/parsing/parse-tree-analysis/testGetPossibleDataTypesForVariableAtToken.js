...
export function testGetPossibleDataTypesForVariableAtToken(logger) {
	const cases = [
		...
		{'code': 'make "x 5.4 print "here', 'types': 'num'},
		{'code': 'make "x true print "here', 'types': 'bool'},
		{'code': 'make "x [] print "here', 'types': 'list'},
		{'code': 'make "x :x print "here', 'types': 'bool|color|gradient|list|num|plist|string|transparent'},
		{'code': 'queue "x 1 print "here', 'types': 'list'},
		{'code': 'fd :x print "here', 'types': 'num'},
		{'code': 'fd :X print "here', 'types': 'num'}, // variables are case-insensitive.
		{'code': 'make "x "here\nfd :x', 'types': 'bool|color|gradient|list|num|plist|string|transparent'},
		...
		{'code': 'fd :x\nprint 4 + :x\nprint "here', 'types': 'num'},
		{'code': 'setfillcolor :x\nprint "here', 'types': 'color|transparent'},
		{'code': 'for ["x 0 5 1] [\nprint "here]', 'types': 'int'},
		{'code': 'for ["y 0 5 1] [\nprint "here]', 'types': 'bool|color|gradient|list|num|plist|string|transparent'},
		{'code': 'for ["x 0 5 1] [for ["y 0 5 1] [\nprint "here]]', 'types': 'int'},
		{'code': 'print "here setpencolor :x', 'types': 'color'},
		{'code': 'print "here setpencolor :x fd :x', 'types': 'int'},
		{'code': 'print "here setpencolor :x make "x 10 fd :x', 'types': 'color'},
		...
		{'code': 'make "x plistCreate print "here', 'types': 'plist'},
		...
		if (!(token instanceof ParseTreeToken))
			...
			if (!(types instanceof DataTypes))
				...
				if (typeString !== caseInfo.types) {
					plogger('Expected ' + caseInfo.types + ' but got ' + typeString);
				}
			}
		}
	});
