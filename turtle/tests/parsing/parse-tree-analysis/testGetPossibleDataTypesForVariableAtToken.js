...
export function testGetPossibleDataTypesForVariableAtToken(logger) {
	const cases = [
		...
		{'code': 'make "x :x print "here', 'types': 'bool|gradient|list|num|plist|string|transparent'},
		...
		{'code': 'make "x "here\nfd :x', 'types': 'bool|gradient|list|num|plist|string|transparent'},
		...
		{'code': 'for ["y 0 5 1] [\nprint "here]', 'types': 'bool|gradient|list|num|plist|string|transparent'},
