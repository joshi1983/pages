...
import { testArrayBracketDenoiser } from './testArrayBracketDenoiser.js';
...
import { testIDontKnowHowToIsMostImportantDenoiser } from './testIDontKnowHowToIsMostImportantDenoiser.js';
...
export function testDenoising(logger) {
	wrapAndCall([
		...
		testArrayBracketDenoiser,
		testCurvedBracketDenoiser,
		testDenoiseParseMessages,
		testIDontKnowHowToIsMostImportantDenoiser,
