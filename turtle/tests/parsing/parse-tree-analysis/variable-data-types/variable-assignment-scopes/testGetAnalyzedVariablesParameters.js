...
function testParameters(logger) {
	const cases = [
		...
		{'code': 'to p :x\nfd :x\nend\np 3 + 4\np 8 + 12',
		'assignedTypes': 'int(max=20,min=20)|int(max=7,min=7)', 'requiredTypes': 'num(finite)'},
		{'code': 'to p :x\nfd :x\nend\np 3.14 + 4.234',
		'assignedTypes': 'num(finite,max=7.3740000000000006,min=7.3740000000000006)',
		'requiredTypes': 'num(finite)'},
			// the ...0006 is floating point error.
		{'code': 'to p :x\nfd :x\nend\np 3 + 4',
			'assignedTypes': 'int(max=7,min=7)', 'requiredTypes': 'num(finite)'},
		...
		{'code': 'to p :X\nend\nto p2 :Y\nend', 'assignedTypes': '', 'requiredTypes': allTypesString},
		{'code': 'to p :x\nfd :x\nend\np 100',
		'assignedTypes': 'int(max=100,min=100)', 'requiredTypes': 'num(finite)'},
		{'code': 'to p :x\nfd :x\nend\np 100\np "hi',
			'assignedTypes': 'int(max=100,min=100)|string', 'requiredTypes': 'num(finite)'},
		...
		{'code': 'to p :x\nmake "x 5\nforward :x\nend', 'assignedTypes': '', 'requiredTypes': allTypesString},
		{'code': 'to p :x\nfd :x\nend\np "hello\np 5',
			'requiredTypes': 'num(finite)', 'assignedTypes': 'int(max=5,min=5)|string'},
