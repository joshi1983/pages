...
import { getVariableScopeStart } from '../../../../modules/parsing/parse-tree-analysis/variable-data-types/getVariableScopeStart.js';
...
export function testGetVariableScopeStart(logger) {
	const cases = [
	...
	cases.forEach(function(caseInfo, index) {
		...
		const variableReferenceToken = cachedParseTree.getTokensByType(ParseTreeTokenType.STRING_LITERAL).
		...
		if (variableReferenceToken === undefined)
			...
			const start = getVariableScopeStart(cachedParseTree, assignmentToken);
