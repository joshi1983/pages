...
export function testVariables(logger) {
	testCountVariables(prefixWrapper('testCountVariables', logger));
	testGetAllVariablesAsArray(prefixWrapper('testGetAllVariablesAsArray', logger));
	testGetVariableByName(prefixWrapper('testGetVariableByName', logger));
};