...
print item 1 :points`, 'varNames': ['points'], 'numScopes': 1, 'scopeChecks': [
{
	'varName': 'points',
	'scopeIndex': 0,
	'assignedTypesStr': 'list<list<num(finite)>(minlen=3)>'
}]},{'code': `make "points []
repeat 100 [
	queue2 "points pos
]
repeat 100 [
	...
	print round :fromPoint / 5 ; a bit weird since fromPoint would be a list.
	; That weirdness is part of the reason for this test case, though.
...
'scopeChecks': [{
	...
	'varName': 'frompoint',
	'scopeIndex': 0,
	'assignedTypesStr': 'list<num(finite)>(minlen=3)'
}]},
{
	'code': `to p1
	maKe "X 0.345
