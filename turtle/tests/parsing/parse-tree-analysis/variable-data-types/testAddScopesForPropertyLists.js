import { addScopesForPropertyLists } from '../../../../modules/parsing/parse-tree-analysis/variable-data-types/addScopesForPropertyLists.js';
...
export function testAddScopesForPropertyLists(logger) {
	...
	cases.forEach(function(caseInfo, index) {
		...
		if (caseInfo.singleValue !== undefined) {
			...
			const xReadToken = cachedParseTree.getTokensByType(ParseTreeTokenType.VARIABLE_READ).
