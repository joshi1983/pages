...
export function testGetTokenValueBasic(logger) {
	...
	const cases = [
		...
		{'tok': new ParseTreeToken("Hello\\'s", null, 0, 0, 
			ParseTreeTokenType.LONG_STRING_LITERAL), 'result': "Hello's"},
		{'tok': new ParseTreeToken("Hello\\'s", null, 0, 0, ParseTreeTokenType.STRING_LITERAL),
			'result': "Hello's"},
		...
		{'tok': new ParseTreeToken("x", null, 0, 0, ParseTreeTokenType.VARIABLE_READ), 'result': undefined},
