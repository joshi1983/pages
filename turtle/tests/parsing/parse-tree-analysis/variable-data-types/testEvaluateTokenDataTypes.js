...
export function testEvaluateTokenDataTypes(logger) {
	const cases = [
		...
		{'code': 'fd 10.23 + 50', 'tokenTypeChecks': [
			{'val': '+', 'types': 'num(finite,min=60.230000000000004)'}
			// the ...00004 is weird but that's floating point error.
			// FIXME: we should handle floating point error in a better way.
		...
		{'code': 'print abs -50.5', 'tokenTypeChecks': [
			{'val': 'abs', 'types': 'num(finite,min=50.5)'}
		]},
