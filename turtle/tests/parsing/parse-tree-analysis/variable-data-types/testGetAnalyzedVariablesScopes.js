...
import { processVariableScopeTestCase } from './processVariableScopeTestCase.js';
...
function testGeneralCases(logger) {
	...
	cases.forEach(function(caseInfo, index) {
		processVariableScopeTestCase(caseInfo, index, logger);
	});
}
...
export function testGetAnalyzedVariablesScopes(logger) {
