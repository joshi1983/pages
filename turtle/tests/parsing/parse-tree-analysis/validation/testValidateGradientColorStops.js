...
export function testValidateGradientColorStops(logger) {
	const cases = [
		{'code': '', 'error': false},
		{'code': 'make "x plistCreate', 'error': false},
		...
		{'code': 'make "x plistCreate\nsetProperty "x 0 "red\n' +
			...
			'setFillGradient :gradient', 'error': true},
		{'code': 'make "x plistCreate\nsetProperty "x 0 "red\nsetProperty "x 1 "blue\n' +
			'make "gradient createRadialGradient [0 0] [100 100] 100 :x "pad\n' +
			'setFillGradient :gradient', 'error': false},
		{'code': 'make "x plistCreate\nsetProperty "x "0 "red\nsetProperty "x 1 "blue\n' +
			'make "gradient createRadialGradient [0 0] [100 100] 100 :x "pad\n' +
			'setFillGradient :gradient', 'error': true},
	...
	cases.forEach(function(caseInfo, index) {
		...
		processValidationTestCase(caseInfo, logger, validateGradientColorStops);
	});
};