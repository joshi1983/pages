...
p [1 2]`, 'error': false},
	...
	{'code': 'print 2 * arcSin 1.3', 'error': true}, 
		// 1.3 is out of range -1..1 so not fitting in the required -1..1 range.
...
// end of minlen-related test cases
	...
	{'code': 'print (invoke "abs -1)', 'error': false},
	{'code': '(invoke "circle 100)', 'error': false},
	];
