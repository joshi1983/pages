...
export function testIsNonColorList(logger) {
	const cases = [
		...
		{'in': 'num(finite,max=0,min=-1)', 'out': false},
		...
		{'in': 'alphacolorlist|list<string>', 'out': false},

		{'in': 'string|transparent', 'out': false},
		{'in': 'list|num', 'out': false}, 
			/* must not have anything but a list in it. lists are not numbers. */

		{'in': 'list', 'out': true},
		{'in': 'list(minlen=999)', 'out': true},
		{'in': 'list<num>', 'out': true},
		{'in': 'list<num(finite)>', 'out': true},
		{'in': 'list<num(unfinite)>', 'out': true},
		{'in': 'list<num(min=infinity)>', 'out': true},
		{'in': 'list<num(min=300)>', 'out': true},
		...
		{'in': 'list<alphacolor|list<alphacolorlist>>', 'out': true},
