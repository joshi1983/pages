...
export function testOrderOfOperation(logger) {
	const cases = [
		...
		{'expr': '1 + 0=1', 'output': true},
		{'expr': '1=1 + 0', 'output': true},
		{'expr': '1<>1', 'output': false},
		{'expr': '1<>0', 'output': true},
		{'expr': '1>0', 'output': true},
		{'expr': '0>1', 'output': false},
		{'expr': '1 + 0.1 > 1', 'output': true},
		{'expr': '1 > 0.1 + 1', 'output': false},
		{'expr': '1 - 1 > 0', 'output': false},
		{'expr': '5 * 1 > 2', 'output': true},
		//{'expr': 'sqrt 100 > 11', 'output': false},
		//{'expr': 'sqrt 100 > 9', 'output': true},
	];
