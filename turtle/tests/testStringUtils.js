...
function testEscapeXMLAttribute(logger) {
	const cases = [
		{'in': 'hi', 'out': 'hi'},
		{'in': 'HI', 'out': 'HI'},
		{'in': 'hi,', 'out': 'hi,'},
	...
	testInOutPairs(cases, StringUtils.escapeXMLAttribute, logger);
}
...
function testIsWhitespace(logger) {
	const cases = [
		{'in': '', 'out': false},
		{'in': 'h', 'out': false},
		{'in': 'H', 'out': false},
	...
	testInOutPairs(cases, StringUtils.isWhitespace, logger);
}

function testRemoveFileExtension(logger) {
	const cases = [
		{'in': '', 'out': ''},
		{'in': 'abc', 'out': 'abc'},
		{'in': 'abc.', 'out': 'abc'},
		{'in': 'abc.t', 'out': 'abc'},
		{'in': 'a.b.c.t', 'out': 'a.b.c'},
	];
	testInOutPairs(cases, StringUtils.removeFileExtension, logger);
}
