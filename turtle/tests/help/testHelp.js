import { testColourBlendModesJSON } from
'./testColourBlendModesJSON.js';
...
import { testGetEqualitiesInvolvingCommand } from
'./testGetEqualitiesInvolvingCommand.js';
...
export function testHelp(logger) {
	wrapAndCall([
		...
		testGetEqualitiesInvolvingCommand,
		testGlossaryJSON,
