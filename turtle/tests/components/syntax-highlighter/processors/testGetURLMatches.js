...
import { getURLMatches } from '../../../../modules/components/syntax-highlighter/processors/getURLMatches.js';
...
export function testGetURLMatches(logger) {
	const cases = [
		...
		},
		{
			...
			{'startIndex': 2, 's': 'http://www.google.com'
			}// a line break should never be included in a match.
			]
		},
	...
	cases.forEach(function(caseInfo, index) {
		...
		const plogger = prefixWrapper(`Failed case with string "${caseInfo.in}", index=${index}`, logger);
