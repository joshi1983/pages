...
const section1 = new LoggedSection('print', token1, true, 0);
const section2 = new LoggedSection('"Hello', token2, true, 0);
...
function testBreakAt(logger) {
	...
	const section = new LoggedSection(s, parsedToken, false, 0);
	const cases = [
...
function testGetStringFromSections(logger) {
	...
	const negativeSection = new LoggedSection('-', negativeToken, true, 0);
	const numSection = new LoggedSection('45', numToken, false, 0);
...
function testSimpleCases(logger) {
	...
	const section = new LoggedSection('print', token, true, 0);
