...
export function testWhitespaceUtils(logger) {
	testCharIndexToTabConsiderateIndex(prefixWrapper('testCharIndexToTabConsiderateIndex', logger));
	testIndexOfWhiteSpace(prefixWrapper('testIndexOfWhitespace', logger));
	testLastIndexOfWhitespace(prefixWrapper('testLastIndexOfWhitespace', logger));
};