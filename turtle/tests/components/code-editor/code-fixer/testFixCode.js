...
export function testFixCode(logger) {
	const cases = [
		...
		{'in': `; https://hackage.haskell.org/cles_animated_300.gif
to`, 'out': `; https://hackage.haskell.org/cles_animated_300.gif
to`},{'in': `to drawShape :size
	localmake "oldState turtleState
	localmake "gap : localmakw "squareSize :size
end`, 'out': `to drawShape :size
	localmake "oldState turtleState
	localmake "gap  :localmakw "squareSize :size
end`},
	];
