...
export function testRemoveUnneededCurvedBrackets(logger) {
	const cases = [
		...
		{'code': 'print ( invoke "sum 3 )', 'logged': false},
		{'code': `print ( word str :a '+' str :b '=' str :e )`, 'logged': false},
		{'code': 'print ( modulo 5 2 ) * 3', 'logged': false},
		{'code': 'print ( modulo 5 2 ) / 2', 'logged': false},
		{'code': 'make "a ( duplicate 0 5 )', 'to': 'make "a  duplicate 0 5 ', 'logged': true},
		{'code': 'print ([])', 'to': 'print []', 'logged': true},
		{'code': `to Circle0 :x :y
 ( arcRight 45 100  )  
end`, 'to': `to Circle0 :x :y
  arcRight 45 100    
end`, 'logged': true},
		{'code': 'if ( :size <= 300 ) []', 'to': 'if  :size <= 300  []', 'logged': true},
		{'code': 'to p output (2 * 3) end',
			'to': 'to p output 2 * 3 end',
			'logged': true},
		{'code': 'print ( power 2 3 )',
			'to': 'print  power 2 3 ',
			'logged': true},
		{'code': 'print 2 + ( 3 * 4 )',
			'to': 'print 2 +  3 * 4 ',
