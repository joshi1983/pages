import { makeAssignFixer } from
'../../../../../modules/components/code-editor/code-fixer/fixers/makeAssignFixer.js';
...
export function testMakeAssignFixer(logger) {
	const cases = [
		...
		{'code': 'make a=400', 'to': 'make "a 400', 'logged': true, 'ignoreParseErrors': true},
		{'code': 'make local x=4 print x', 'to': 'localmake  "x 4 print :x', 'logged': true},
		{'code': 'make x=4\nprint "hi',
			'to': 'make "x 4\nprint "hi',
			'logged': true
		},
		{'code': 'make a=a*.78', 'to': 'make "a :a*.78', 'logged': true, 'ignoreParseErrors': true},
		{'code': 'make d=d-65', 'to': 'make "d :d-65', 'logged': true,
