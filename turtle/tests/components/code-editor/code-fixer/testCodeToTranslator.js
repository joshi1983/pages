...
'../../../../modules/parsing/other-languages/l-systems/0L/translation-to-weblogo/translate0LToWebLogo.js';
import { translateAmosBasicToWebLogo } from
'../../../../modules/parsing/other-languages/basic/amos-basic/translation-to-weblogo/translateAmosBasicToWebLogo.js';
...
'../../../../modules/parsing/other-languages/basic/basic-256/translation-to-weblogo/translateBasic256ToWebLogo.js';
...
'../../../../modules/parsing/other-languages/basic/basil/translation-to-weblogo/translateBasilBasicToWebLogo.js';
import { translateBazzBasicToWebLogo } from
'../../../../modules/parsing/other-languages/basic/bazz-basic/translation-to-weblogo/translateBazzBasicToWebLogo.js';
...
'../../../../modules/parsing/other-languages/l-systems/cgjennings/translation-to-weblogo/translateCGJenningsToWebLogo.js';
...
'../../../../modules/parsing/other-languages/basic/commodore-basic/translation-to-weblogo/translateCommodoreBasicToWebLogo.js';
...
'../../../../modules/parsing/other-languages/l-systems/fractint/translation-to-weblogo/translateFractIntToWebLogo.js';
import { translateJSProcessingToWebLogo } from
'../../../../modules/parsing/other-languages/processing/js-processing/translation-to-weblogo/translateJSProcessingToWebLogo.js';
...
'../../../../modules/parsing/other-languages/basic/texas-instruments-99-4a/translation-to-weblogo/translateTI99BasicToWebLogo.js';
...
]).concat(billNyeExamples, odinExamples, osmosianExamples);
...
addCases(basic256Examples, translateBasic256ToWebLogo, false);
addCases(basicFusionExamples, translateBasicFusionToWebLogo, false);
addCases(basilBasicExamples, translateBasilBasicToWebLogo, false);
addCases(bazzBasicExamples, translateBazzBasicToWebLogo, false);
addCases(bbcBasicExamples, translateBBCBasicToWebLogo, false);
addCases(cgjenningsExamples, translateCGJenningsToWebLogo, false);
...
addCases(fractintExamples, translateFractIntToWebLogo, false);
addCases(germanLogoExamples, germanLogoToWebLogo, false);
...
addCases(kojoExamples, translateKojoToWebLogo, false);
addCases(kturtleExamples, translateKTurtle, false);
addCases(logo3DExamples, logo3DToWebLogo, true);
addCases(logoInterpreterExamples, logoInterpreterToWebLogo, false);
addCases(microAExamples, translateMicroABasicToWebLogo, false);
addCases(papertExamples, papertToWebLogo, true);
addCases(pBasicExamples, translatePBasicToWebLogo, false);
addCases(pitrifiedGoTurtleExamples, translatePitrifiedGoTurtleToWebLogo, false);
...
addCases(seaTurtleExamples, translateSeaTurtleToWebLogo, false);
...
addCases(turingExamples, translateTuringToWebLogo, false);
addCases(turtleGraphicsFunExamples, translateTurtleGraphicsFunToWebLogo, false);
addCases(turtleToyNetExamples, translateTurtleToyNetToWebLogo, false);
addCases(zeroLExamples, translate0LToWebLogo, false);
