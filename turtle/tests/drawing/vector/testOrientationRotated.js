...
export function testOrientationRotated(logger) {
	testHeadingAndPitchCombo(prefixWrapper('testHeadingAndPitchCombo', logger));
	testHeadingAndRollCombo(prefixWrapper('testHeadingAndRollCombo', logger));
	testPitchAndRollCombo(prefixWrapper('testPitchAndRollCombo', logger));
	testHeadings(prefixWrapper('testHeadings', logger));
	testPitches(prefixWrapper('testPitches', logger));
	testRolls(prefixWrapper('testRolls', logger));
};