...
const cases = [
	{
		'code': await fetchText('tests/data/logo-scripts/bounding-box-test.lgo'),
		'minX': -200,
		'maxX': 200,
		'minY': 0,
		'maxY': 50
	...
	{
		'code': await fetchText('tests/data/logo-scripts/bounding-box-miter-line1.lgo'),
		'minX': -14.1,
		'maxX': 48.3,
		'minY': -5.1,
		'maxY': 99.1
	...
	{
		'code': await fetchText('tests/data/logo-scripts/bounding-box-round-line1.lgo'),
		'minX': -15,
		'maxX': 49.3,
		'minY': -15,
		'maxY': 109
