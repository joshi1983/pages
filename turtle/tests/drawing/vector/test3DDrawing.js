...
export function test3DDrawing(logger) {
	...
	testDefaultConstructor(prefixWrapper('testDefaultConstructor', logger));
	testListeners(prefixWrapper('testListeners', logger));
	testMethods(prefixWrapper('testMethods', logger));
}