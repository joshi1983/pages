...
export function testOptimizeDrawing(logger) {
	testOptimizeGeneralDrawing(prefixWrapper('testOptimizeGeneralDrawing', logger));
	testOptimizeLineSegmentJoinStyle(prefixWrapper('testOptimizeLineSegmentJoinStyle', logger));
};