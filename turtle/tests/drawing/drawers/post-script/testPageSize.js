...
export function testPageSize(logger) {
	testFillSelect(prefixWrapper('testFillSelect', logger));
	testGetDefaultPageSize(prefixWrapper('testGetDefaultPageSize', logger));
	testGetShortName(prefixWrapper('testGetShortName', logger));
	testWidthHeight(prefixWrapper('testWidthHeight', logger));
};