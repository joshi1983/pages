...
export function testSVGVector2DDrawer(logger) {
	testPath(prefixWrapper('testPath', logger));
	testTransparentScreenColor(prefixWrapper('testTransparentScreenColor', logger));
	testWithTestDrawing(prefixWrapper('testWithTestDrawing', logger));
};