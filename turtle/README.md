...
- fix bug: when Edge browser's zoom is not 100%, the Code Editor sizes its textarea badly.  The height does not match the line numbers.
...
- add feature to search examples by command usage.  For example, "cmd:arcRight".
