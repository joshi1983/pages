...
- use https://github.com/yWorks/svg2pdf.js/


- fix minor bug. canvas draws path corners badly sometimes.  This can be reproduced by:
	- loading logo-scripts/art/greek-monogram-frame.lgo and zooming in and out.
...
- implement a downscaling feature for any low resolution image downloads to improve their quality with high detail drawings.

- update aspect ratio drawing while setting the animation time and redraw the aspect ratio lines.
...
- trigger a color selection feature when right-clicking on a color literal in the code editor.
...
- find and fix minor bug where previewer cuts off a strip at the right side of the drawing when 640 by 480 resolution is selected.
	- might be related to padding of the container

- help for the invoke command needs more detail.
	- list commands that can not be used for invoke.
	- use the isSupportedByHighOrderInvoke module.
...
- add an example similar to: https://www.youtube.com/watch?v=WEUloPdIfRk
...
- after 3D modeling is working well, add a 3D example similar to the model in this video: https://www.youtube.com/watch?v=zrmVxVRjLMw
...
- make the Drawing -> Load... menu item load a raster image for a background.
...
- add a variable tracing feature for non-maximum speed execution.
	- This would be accessed from the Debugger.
	- click a variable or parameter and you'd see a report of any recorded lines of code, old value/new value...
