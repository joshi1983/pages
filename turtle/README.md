...
Add commands like getArcLeftAngleToCircle :arcRadius :circleCenter :circleRadius
 and getArcRightAngleToCircle.
	- Apply these new commands to examples such as crop-circles/cleyhill-2017-crop-circles.lgo fillIntersectedArc procedure.
	- See if north-42-degrees-vineyard-logo.lgo could use it.  Some arcs intersect circles there.
	- Search for other examples that could use it.  
