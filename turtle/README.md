...
fix minor bug involving animation duration not initially loading.
Steps to reproduce:
	1. Define an animation where animation.setup indicates the duration to be 3 seconds.  Get the program in a runnable/bug-free state.
	2. Refresh the browser.
	3. Go to Set -> Animation Time.
	4. Notice the duration is indicated at 10 despite the animation.setup indicating 3.  That is the bug.
