...
DONE: - for the processing translator, improve translation in for-loops.  Translate some cases to WebLogo's repeat and for.
...
DONE: Add a glossary index or list to the help feature.
...
- after 3D modeling is working well, 
	...
	- add a 3D model similar to: https://www.youtube.com/watch?v=jYY6DbJ4WEM
	- add examples similar to a drawing at: https://upload.wikimedia.org/wikipedia/commons/e/ee/Haeckel_Hexactinellae.jpg
	- add examples similar to 3D models in the video at:
	https://www.facebook.com/share/v/1Gju5B6365/
	- add examples similar to a 3D animation at:
	https://www.facebook.com/share/r/193mCRssUf/
...
- create an example for:
	https://ca.pinterest.com/pin/202662051966066211/
	- get some ideas from: https://www.youtube.com/watch?v=gI9CPBWEiXc

The following should validate with at least a warning about comparing very different types of values being hard to read.
print 'hi' < 3
...
- Export Gaussian splats.
	- A PLY option is explained at: https://developer.playcanvas.com/user-manual/gaussian-splatting/formats/ply/
...
Research the graphic file format using extension "iff".
	- Is it worth supporting the format for image assets similar to our support of BMP and PCX file formats?
	- One IFF file is at: https://github.com/alain-treesong/amiga_coding_in_amos/blob/main/snippet-011_copperProgramming/src/castle.iff
	- The format loads into GIMP.
...
- in QBasic, use the global palette variable to get colours for lines, circles...
- in the image exporter, add a feature to autocenter the drawing.
- revisit fast-pixels.  Can we use it for drawing Julia Set and Mandelbrot fractals?
- make it so the slow loading process informs the user about what is loading.  Help new visitors see that WebLogo isn't just frozen or buggy.
...
Algorithmic Paintbrush
Algorithmic Art Studio
Algorithmic Studio
Turtle Graphic Studio
...
slogan ideas:
*your algorithmic art studio*
the fun of turtle graphics
graphics with the power of programming
the best turtle graphics programming environment
graphics programming made easy
code something beautiful
your graphics programming environment
the best graphics programming environment
the universal graphics programming environment
code beauty
code your vision
create something beautiful
code your ideas to life
where art meets code
where art and code mix
...
draw with code
paint with code
have fun with WebLogo. Benefits will follow.
have fun. Discover the benefits.
share your ideas
express yourself
spark your ideas into being
