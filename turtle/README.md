...
- Add support for escape characters like \ in string literals.
...
- FIX bug: some SVG's are drawn to canvas using imageAlpha and image commands 
ignoring the specified aspect ratio.
	Drawing to SVG follows the aspect ratio correctly.  Both ways of drawing should work with the dimensions specified in the command.
