...
'../../modules/parsing/other-languages/js-parsing/parsing/parse-tree-analysis/validation/analyzeQuality.js';
import { BufferedParseLogger } from '../../modules/parsing/loggers/BufferedParseLogger.js';
import { CachedParseTree } from '../../modules/parsing/other-languages/js-parsing/parsing/parse-tree-analysis/CachedParseTree.js';
...
'../../modules/parsing/other-languages/js-parsing/parsing/parse-tree-analysis/validation/validating-modules/validateModule.js';
...
function refreshTranslation(code) {
	translatedOutputContainer.innerText = translateToWebLogo(code);
}
...
function init() {
	...
	translatedOutputContainer = document.getElementById('code-translated');
